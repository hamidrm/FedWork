...
def make_equal_len_mnist_loaders(dataset_name, batch_size=128, seed=42):
    g = torch.Generator().manual_seed(seed)
...
def measure_mia(output_file):
    ...
    member_dataset, nonmember_dataset, _ = _make_eval_transforms_and_datasets(ds_type)
    ...
    arch.SetParameter("NumberOfOutputNodes", len(member_dataset.classes))
    ...
    calc_yoem(global_model, member_dataset, nonmember_dataset)
    
    
measure_mia("output/fedalaq_cifar100_resnet18_comm_0_1/FedAvg_probes_data.data")