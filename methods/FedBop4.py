...
class FedBop4(FederatedLearningClass):
    ...
    def __init__(self, method_name, fl_context, method_args):
        ...
        self.m_buffers = None
        self.e_buffers = None  # compatibility only; unused by sparse projection
    ...
    def _diag_log(self, message):
        ...
        text = f"[FedBopBopRequestMajoritySparseProjection] {message}"
    ...
    def pack_client_model(self, raw_model, global_model, id):
        ...
        if self.diag:
            ...
            self._diag_log(
                f"CLIENT_BOP_REQUEST_MAJ round={round_number} id={id} gamma={self.gamma:.3e} projection=canonical_tau "
    ...
    def aggregate(self, clients_models, global_model):
        ...
        if self.diag:
            ...
            self._diag_log(
                ...
                f"evidence=local_temporal_bop_request_majority_positive_only_sparse_projection boundary={decision_boundary:.1f} "
